{
  ...
  inputs = {
    ...
    node-template = {
      url = "github:spotdemo4/node-template/4f12f3e48de0922296d3de6259b267674d0fcb3f";
      inputs = {
        systems.follows = "systems";
        nixpkgs.follows = "nixpkgs";
        trev.follows = "trev";
    ...
    rust-template = {
      url = "github:spotdemo4/rust-template/1255ebcf88f845b24af21d59472bee8f245739f0";
      inputs = {
        systems.follows = "systems";
        nixpkgs.follows = "nixpkgs";
        trev.follows = "trev";
