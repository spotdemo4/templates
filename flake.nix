{
  ...
  inputs = {
    ...
    node-template = {
      url = "github:spotdemo4/node-template/2755219c1eb1e3c962be7a81f4f6d617cd32be9e";
      inputs = {
        systems.follows = "systems";
        nixpkgs.follows = "nixpkgs";
        trev.follows = "trev";
    ...
    gleam-template = {
      url = "github:spotdemo4/gleam-template/14b24b55c75faf6843c23ebf260460aff5ab1b63";
      inputs = {
        systems.follows = "systems";
        nixpkgs.follows = "nixpkgs";
        trev.follows = "trev";
